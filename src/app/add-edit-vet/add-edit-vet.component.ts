...
@Component({
  selector: 'app-add-edit-vet',
  templateUrl: './add-edit-vet.component.html',
  styleUrls: ['./add-edit-vet.component.scss'],
...
export class AddEditDoctorComponent {
  ...
  onSaveClick() {
    ...
    const activityObj: { [key: string]: Object } = {
      Name: this.dialogState === 'new' ? 'Added New Vet' : 'Updated Vet',
